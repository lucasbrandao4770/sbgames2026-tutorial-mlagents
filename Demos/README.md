...
As duas foram gravadas no editor Unity com o componente Demonstration Recorder, durante o TCC de Lucas Brandão Rodrigues (2024), e são cópias binárias idênticas às de `unity/SBGamesMLAgents/Assets/FlappyBird/Demos/`.
